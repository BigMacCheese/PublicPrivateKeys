...
public class ThreadCliente extends Thread{
	...
	public void run() {
		...
		try {
			...
			boolean checkS = f.checkSignature(publicaServidor, firma, msj);
			long end1 = System.nanoTime();      
			System.out.println("Cliente" + this.idC + "---" + "Tiempo requerido para la verificaci�n de la firma en ns: "+ (end1-start1));
			...
			if(checkS) {
				...
				System.out.println("Cliente" + this.idC + "---" + "Tiempo requerido para la generacion de Gy en ns: "+ (end2-start2));
				...
				System.out.println("Cliente " + this.idC + "-" + "llave maestra: " + strLlaveMaestra);
				...
				System.out.println("Cliente" + this.idC + "---" + "Tiempo requerido para la generacion del codigo de autenticacion de la firma en ns: "+ (end3-start3));
